...
public class lexical_Analysis {
    ...
    private String patron = ("(include|stdio.h|stdlib.h|main|for|while|true|false|double|if|int|float|do|bool|char|String|cout|printf|scanf|else|ope:|%d|%f|%s|%c)|"//palabras reservadas
                            + "([a-zA-Z]+)|"//variables
                            + "([#|(|)|<|>|[|]|{|}|+|-|*|/|;|=|'|,|.|\"|&|!]+)|"//simbolos
                            + "([0-9]+)");//numeros
