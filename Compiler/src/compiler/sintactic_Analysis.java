...
public class sintactic_Analysis {
        ...
        for(int i = 0; i < data.count_symbols; i++)
        {
            ...
            if(printf == true)
            {
                ...
                for(int j = (indice + 3); j < data.count_symbols; j++)
                {
                    ...
                    {
                        texto = texto + 1;
                        data.SymbolsTable[j][2] = "correcto";
                    }
                    try{
    ...
    public void vali(){
        ...
        {
            try{
                if(data.SymbolsTable[i][1].equals("texto")&& data.SymbolsTable[i][2].equals("erroneo"))
                {
                    var = true;
                }
            }catch(NullPointerException e){}
        ...
        {
            this.indice_errores = indice_errores + 1;
            this.errores[indice_errores] = "Error.-elementos desconocidos";
        }
    }
